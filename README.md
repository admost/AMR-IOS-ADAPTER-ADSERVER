![AMRAdapterAdserver: Admost Mediation iOS SDK](https://www.admost.com/img/logo.svg)
...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/AMRAdapterAdserver.svg?style=flat-square)](https://img.shields.io/cocoapods/v/AMRAdapterAdserver.svg)
...
Adserver adapter for AMRSDK. Allows publishers to mediate Adserver banner, native, interstitial and video ads in AMRSDK.
...
```
https://github.com/admost/AMR-IOS-ADAPTER-ADSERVER.git
```
